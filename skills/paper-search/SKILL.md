...
`<this-skill-directory>/scripts/search_papers.py` (locate relative to this SKILL.md's own directory; do not assume any specific project env var) — invoke
...
```bash
SEARCH="$(dirname "<path-to-this-SKILL.md>")/scripts/search_papers.py"   # i.e. the scripts/ folder next to this SKILL.md
```
